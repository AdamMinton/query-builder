...
export const ModelAndExploreMenu = ({ models, explores, activeModel, activeExplore, setActiveModel, setActiveExplore, setFilters, coreSDK }) => {
...
ModelAndExploreMenu.propTypes = {
  ...
  activeExplore: PropTypes.string, // delete
  setActiveModel: PropTypes.func,
  setActiveExplore: PropTypes.func,
  setFilters: PropTypes.func, // delete
  coreSDK: PropTypes.object // delete
}
